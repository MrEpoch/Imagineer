...
import { Toaster } from "@/comp-ui/ui/toaster";
...
export default function MainLayout({
  ...
  return (
    <main className="relative min-h-screen h-full dark:text-white text-black dark:bg-background w-full flex flex-col">
      <ErrorHandler />
      <LoadCurrentSidebar />
      <Sidebar className="dark:bg-background bg-white border-r z-10 border-zinc-100 w-full md:w-80 dark:border-border fixed min-h-screen dark:text-white text-gray-700" />
