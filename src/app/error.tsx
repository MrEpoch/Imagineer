...
export default function Error({ error, reset }) {
  return (
    ...
    className="text-white bg-red-400 border-2 transition border-red-600 hover:bg-red-600 px-4 py-2 rounded-md text-center"
      ...
      <Link className="text-white dark:bg-darkmode-800 bg-gray-50 hover:bg-gray-100 transition dark:hover:bg-darkmode-700 px-4 py-2 rounded-md text-center" href="/">Home</Link>
    </div>
    </div>
  )
}
