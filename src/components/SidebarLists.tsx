...
export default function SidebarLists() {
  ...
  const normalClassName =
    "flex items-center p-2 text-darkmode-900 rounded dark:text-white hover:bg-darkmode-100 dark:hover:bg-darkmode-700 group";
  const activeClassName =
    "flex items-center p-2 text-darkmode-900 bg-darkmode-100 rounded dark:text-white dark:bg-darkmode-700 group";
    ...
    <>
      ...
      <li>
        ...
        >
          ...
          <span className="flex-1 ms-3 whitespace-nowrap">Image restore</span>
        </Link>
      </li>
      <li>
        <Link
        ...
        >
          ...
          <span className="flex-1 ms-3 whitespace-nowrap">Generative fill</span>
        </Link>
      </li>
      <li>
        <Link
        ...
        >
          ...
          <span className="flex-1 ms-3 whitespace-nowrap">Object remove</span>
        </Link>
      </li>
      <li>
        <Link
          href={"/object-recolor"}
          className={colored.recolor ? activeClassName : normalClassName}
        >
          <svg
            className="flex-shrink-0 w-5 h-5 text-darkmode-500 transition duration-75 dark:text-darkmode-400 group-hover:text-darkmode-900 dark:group-hover:text-white"
            aria-hidden="true"
          ...
          <span className="flex-1 ms-3 whitespace-nowrap">Object recolor</span>
        </Link>
      </li>
      <li>
        <Link
          href={"/background-remove"}
          className={colored.bg_remove ? activeClassName : normalClassName}
        >
          <svg
