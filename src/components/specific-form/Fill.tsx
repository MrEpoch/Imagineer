  ...
  return (
    <CustomField
      render={({ field }: any) => (
        ...
        >
          <SelectTrigger
            className="border-0 shadow-md bg-white dark:bg-card text-dark-600 w-full placeholder:text-dark-400 h-[50px] text-sm font-medium 
          ...
          <SelectContent className="">
            {Object.keys(aspectRatioOptions).map((k) => (
              <SelectItem
                ...
                value={k}
                className="
              text-sm bg-white dark:bg-card text-black dark:text-white font-bold cursor-pointer transition-all px-8 py-3 
